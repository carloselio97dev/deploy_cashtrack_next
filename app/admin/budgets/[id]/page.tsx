...
import AddExpensesButton from "@/app/components/expenses/addExpensesButton";
...
interface PropsBudgetDetailsPage {
    params: Promise<{ id: string }>
}


export default async function BudgetDetailsPage({ params }: PropsBudgetDetailsPage) {
    const { id } = await params;
    ...
    return (
        <>
            ...
            {budget.expenses.length ? (
                ...
                <h1 className="text-4xl font-black text-center text-purple-950 mt-10">Gastos em este presupuesto</h1>
